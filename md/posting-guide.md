...
Bugs in contributed CRAN packages should normally be reported directly to the package maintainer (as reported by the command `maintainer("package-name")`. You may also be able to obtain help with a problem from the package maintainer.
